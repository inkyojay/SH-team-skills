...
```
1. Glob으로 "/Users/inkyo/ai 디자인/output/*/plan.json" 검색
...
```
mkdir -p "/Users/inkyo/ai 디자인/output/{slug}/photos/{products,lifestyle,logo,etc}"
```
...
📁 소재 폴더: `/Users/inkyo/ai 디자인/output/{slug}/photos/`
...
```bash
mkdir -p "/Users/inkyo/ai 디자인/output/{slug}"
```
Write 도구로 `/Users/inkyo/ai 디자인/output/{slug}/plan.json` 저장.
...
```json
{
  ...
  "materials": {
    "base_dir": "/Users/inkyo/ai 디자인/output/{slug}/photos",
    "photos": [
  ...
  "channels": ["인스타그램", "네이버"],
  "deliverables": [],
  "project_dir": "/Users/inkyo/ai 디자인/output/{slug}/",
  "json_file": "/Users/inkyo/ai 디자인/output/{slug}/plan.json"
}
```
...
경로: `/Users/inkyo/Projects/team-skills/skills/promotion/promo-html/references/channel-specs.md`
...
경로: `/Users/inkyo/Projects/team-skills/skills/promotion/promo-html/references/variable-guide.md`

### 디자인 시스템 로드

`references/design-system.md`를 Read로 읽어 브랜드 컬러/타이포/컴포넌트를 확인합니다.
경로: `/Users/inkyo/Projects/team-skills/skills/promotion/promo-html/references/design-system.md`
...
```bash
mkdir -p "/Users/inkyo/ai 디자인/output/{slug}/html"
mkdir -p "/Users/inkyo/ai 디자인/output/{slug}/png"
mkdir -p "/Users/inkyo/ai 디자인/output/{slug}/pen"
```

### HTML 생성 규칙 로드

`references/html-generation-rules.md`를 Read로 읽어 HTML 작성 규칙을 확인합니다.
경로: `/Users/inkyo/Projects/team-skills/skills/promotion/promo-html/references/html-generation-rules.md`

### 레퍼런스 이미지 확인

각 채널의 레퍼런스 이미지를 Read로 확인하여 레이아웃/스타일을 파악합니다.
레퍼런스 이미지 베이스 경로: `/Users/inkyo/ai 디자인/`
...
- 포맷: {format}
- 사이즈: {width} × {height}
- 출력 파일: /Users/inkyo/ai 디자인/output/{slug}/html/{filename}
...
3. 아래 채널 레퍼런스 이미지를 Read로 확인하여 레이아웃 참고:
   /Users/inkyo/ai 디자인/{레퍼런스 경로}
3. 아래 디자인 시스템 파일을 Read로 읽어 브랜드 컬러/타이포 확인:
   /Users/inkyo/Projects/team-skills/skills/promotion/promo-html/references/design-system.md
4. 아래 HTML 규칙 파일을 Read로 읽어 구조/규칙 확인:
   /Users/inkyo/Projects/team-skills/skills/promotion/promo-html/references/html-generation-rules.md
...
```
Glob: "/Users/inkyo/ai 디자인/output/{slug}/html/*.html"
```
...
```bash
python3 /Users/inkyo/Projects/team-skills/skills/promotion/promo-html/scripts/render_all.py \
  --input-dir "/Users/inkyo/ai 디자인/output/{slug}/html/" \
  --output-dir "/Users/inkyo/ai 디자인/output/{slug}/png/" \
  --scale 2
```
...
출력 경로: `/Users/inkyo/ai 디자인/output/{slug}/pen/{filename}.pen`
...
### 파일 위치
- 기획서: `/Users/inkyo/ai 디자인/output/{slug}/plan.json`
- HTML: `/Users/inkyo/ai 디자인/output/{slug}/html/`
- PNG: `/Users/inkyo/ai 디자인/output/{slug}/png/`
- PEN: `/Users/inkyo/ai 디자인/output/{slug}/pen/`
